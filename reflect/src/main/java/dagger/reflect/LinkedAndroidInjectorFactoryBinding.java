...
final class LinkedAndroidInjectorFactoryBinding<T>
  ...
  LinkedAndroidInjectorFactoryBinding(
      Scope scope, Class<?>[] moduleClasses, Class<T> instanceClass, Set<Annotation> annotations) {
    this.scope = scope;
  ...
  public AndroidInjector.Factory<T> get() {
    return new ReflectiveAndroidInjector.Factory<>(
